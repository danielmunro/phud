...
INSERT INTO `inventories` VALUES (1,'users',1),(2,'bag',1),(7,'room',1),(6,'room',5),(8,'room',2),(9,'users',0),(10,'users',0),(11,'users',0),(12,'users',0),(13,'users',0),(14,'users',0),(15,'users',2),(16,'users_eq',2);
...
INSERT INTO `items` VALUES (1,'a sub issue mace','a sub issue mace is here.','sub mace',100,4.0,0,'5',1,NULL,'pound',NULL,15,0,NULL,0,3,1,2,NULL,NULL,NULL,NULL,'',3),(2,'a sub issue sword','a sub issue sword is here.','sub sword',100,4.0,0,'5',1,NULL,'slash',NULL,16,0,NULL,0,1,1,2,NULL,NULL,NULL,NULL,'',1),(3,'a wooden torch','a wooden torch is here.','wooden torch',1,1.0,0,'6',1,0,'',NULL,16,0,NULL,0,NULL,NULL,NULL,0,0,0,0,'light',NULL),(4,' a pumpkin pie','a delicious pumpkin pie is here.','pumpkin pie',4,0.5,0,'3',1,NULL,'',10,15,0,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'',NULL),(5,' a pumpkin pie','a delicious pumpkin pie is here.','pumpkin pie',4,0.5,0,'3',1,NULL,'',10,15,0,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'',NULL),(6,' a pumpkin pie','a delicious pumpkin pie is here.','pumpkin pie',4,0.5,0,'3',1,NULL,'',10,15,0,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'',NULL),(7,' a pumpkin pie','a delicious pumpkin pie is here.','pumpkin pie',4,0.5,0,'3',1,NULL,'',10,15,0,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'',NULL);
...
CREATE TABLE `skillsets` (
  ...
  `fk_user_id` int(10) unsigned NOT NULL,
  UNIQUE KEY `fk_user_id` (`fk_user_id`,`skill`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `skillsets` VALUES ('kick',50,2),('kick',0,11);
...
-- Dump completed on 2010-07-05 17:57:58
