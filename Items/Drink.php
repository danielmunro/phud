<?php
	...
	class Drink extends Item
	{
		...
		public function __construct($id, $long, $short, $nouns, $value, $weight, $condition, $thirst, $shop = false)
		{
			$this->id = $id;
			$this->long = $long;
			$this->short = $short;
		...
		public function save($inv_inside_id)
		{
			if($this->id)
				return Db::getInstance()->query(
					...
					WHERE
						...
						$this->equipment_position, $this->verb, $this->thirst, $inv_inside_id, 
						$this->id));
			...
			Db::getInstance()->query(
				...
				$this->verb, $this->thirst, $inv_inside_id));
